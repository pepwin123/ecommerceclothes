    ...
    <div className="container xl:mx-[9rem] sm:mx-[0]">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-3/4 p-3">
          <div className="h-12 text-black">Create Product</div>
          ...
          <div className="p-3">
            <div className="flex flex-wrap">
              ...
              <div className="two ml-10 ">
                <label htmlFor="name block"  className="text-black">Price</label> <br />
                <input
                  type="number"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white"
                  value={price}
            ...
            <div className="flex flex-wrap">
              <div className="one">
                <label htmlFor="name block"  className="text-black">Quantity</label> <br />
                <input
                  type="number"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white"
                  value={quantity}
              ...
              <div className="two ml-10 ">
                <label htmlFor="name block"  className="text-black">Brand</label> <br />
                <input
                  type="text"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white"
                  value={brand}
            ...
            <div className="flex justify-between">
              <div>
                <label htmlFor="name block"  className="text-black">Count In Stock</label> <br />
                <input
                  type="text"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white"
                  value={stock}
